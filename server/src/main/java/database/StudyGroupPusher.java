...
/**
 * The `StudyGroupPusher` class is responsible for inserting `StudyGroup` objects and their related data into the database.
 * It handles the insertion of coordinates, group admins, and admin locations.
 */
public class StudyGroupPusher {
    ...
    /**
     * Constructs a `StudyGroupPusher` object.
     */
    public StudyGroupPusher() {
    }

    /**
     * Inserts the coordinates of a `StudyGroup` into the database.
     *
     * @param studyGroup The `StudyGroup` object whose coordinates are to be inserted.
    ...
    /**
     * Inserts the group admin of a `StudyGroup` into the database.
     *
     * @param studyGroup The `StudyGroup` object whose group admin is to be inserted.
     * @param connection The database connection to use.
     * @throws LogException               If there is an error during the insertion process.
     * @throws UnsuccesfulInsertException If the insertion fails.
     */
    ...
    /**
     * Inserts the location of a group admin into the database.
     *
     * @param admin      The `Person` object representing the group admin whose location is to be inserted.
     * @param connection The database connection to use.
     * @throws LogException               If there is an error during the insertion process.
     * @throws UnsuccesfulInsertException If the insertion fails.
     */
    ...
    /**
     * Inserts a `StudyGroup` object and its related data into the database.
     *
