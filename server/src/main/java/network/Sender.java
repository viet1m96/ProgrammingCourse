...
public class Sender implements Callable<Response> {
    ...
    public void sendAResponse(Response response) throws LogException {
        try {
            ...
            System.out.println("The response has been sent to " + response.getClientAddress() + ".");
            LogUtil.logInfo("The response has been sent to " + response.getClientAddress() + ".");
        } catch (IOException e) {
            LogUtil.logTrace(e);
            System.out.println("There was a problem with sending process!");
    ...
    public Response call() {
        ...
        try {
            ...
            LogUtil.logTrace(e);
            System.out.println("There was a problem with sending process, please look at the log file for more details.");
        }
        return response;
    }
}
