...
public class ConsoleReaderMode implements ReadMode {
    ...
    @Override
    public void executeMode(Renderer renderer, Transporter transporter, String nameCommand, String argCommand) throws UserException, LogException, NetworkException {
        BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
        Request request = new Request(nameCommand, argCommand, build(br));
        transporter.transport(request);
    }
}
