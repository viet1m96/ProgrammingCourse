...
public class ModeManager {
    ...
    public void call(Renderer renderer, Transporter transporter, String nameCommand, String arguments) throws UserException, LogException, NetworkException {
        readModes.get(nameCommand).executeMode(renderer, transporter, nameCommand, arguments);
    }
}
